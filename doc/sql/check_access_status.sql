...
WITH expected_tables AS (
    ...
    UNION SELECT 'outpatient_visit_active', 'OutpatientVisitActive'
    UNION SELECT 'outpatient_visit_history', 'OutpatientVisitHistory'
    ...
    UNION SELECT 'emr_drug_dictionary', 'DrugDictionary'
    UNION SELECT 'emr_drug_unit_dict', 'DrugUnitDict'
    UNION SELECT 'emr_drug_form_dict', 'DrugFormDict'
    UNION SELECT 'emr_drug_master', 'DrugMaster'
    UNION SELECT 'emr_drug_spec', 'DrugSpec'
    UNION SELECT 'emr_exam_type_dict', 'ExamTypeDict'
    UNION SELECT 'emr_exam_body_part_dict', 'ExamBodyPartDict'
    UNION SELECT 'emr_exam_item_dict', 'ExamItemDict'
    UNION SELECT 'emr_exam_item_part_map', 'ExamItemPartMap'
    UNION SELECT 'emr_lab_item_dict', 'LabItemDict'
    UNION SELECT 'medical_order_exam_part', 'MedicalOrderExamPart'
