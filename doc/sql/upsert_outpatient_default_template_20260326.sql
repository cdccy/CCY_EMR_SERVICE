...
ALTER TABLE public.emr_template
  ALTER COLUMN template_structure SET DEFAULT '{}'::jsonb;
...
VALUES (
  'OUTPATIENT_DEFAULT_XML_20260326',
  '门诊默认模板-入院记录通用测试',
  'OUTPATIENT',
  'HOSPITAL',
  jsonb_build_object(
 ...
 发病节气：发病节气   
   ...
   <PageSettings>
    ...
    jsonb_build_object(
      ...
      'mode', 'view',
      'version', '1.0',
      'source_file', '/Users/ccy/Downloads/入院记录通用测试.xml',
      'imported_at', to_char(NOW(), 'YYYY-MM-DD"T"HH24:MI:SS')
    )
  )::jsonb,
  true,
  NOW(),
